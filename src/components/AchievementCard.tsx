...
export default function AchievementCard ({ achievement }: AchievementCardProps): JSX.Element {
  return (
   <Box sx={[FLEX_ROW, {
     ...
     borderImageSource: (achievement.unlocked === true) ? 'linear-gradient(90deg, rgba(34,197,94,1) 0%, rgba(45,212,191,1) 68%)' : '',
     borderImageSlice: 1,
    ...
    <Box sx={[FLEX_COLUMN_CENTER, {
      ...
      textAlign: 'center'
        ...
        <Typography sx={{ color: 'white', fontWeight: 'bold', textAlign: 'center', fontFamily: 'cinzel' }}>
            {achievement.name}
        </Typography>
