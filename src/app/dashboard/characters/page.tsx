...
export default function Characters (): JSX.Element {
  ...
  return (
    <div className="w-full h-5/6 flex flex-col gap-4 items-center justify-center">
      <h1 className={`${cinzel.className} font-semibold text-white text-xl sm:text-3xl`}>
        Characters
      </h1>
      <input className="sm:w-1/4 w-1/2 sm:h-8 rounded  border-white  bg-zinc-800 border text-zinc-400 pl-2 dark:border-zinc-400 outline-none " type="text" onChange={handleChange} />
